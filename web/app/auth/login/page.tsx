        ...
        <div className="w-full max-w-sm space-y-5">
          <div className="text-center mb-8">
            ...
            <p className="text-white/50 text-sm">
              {mode === "signin" ? "Sign in to access your tours" : "Start exploring for free"}
            </p>
          </div>
          ...
          <p className="text-center text-sm text-white/40">
            {mode === "signin" ? (
              <>No account?{" "}
                <button onClick={() => { setMode("signup"); setError(""); setMessage(""); }} className="text-white underline">Sign up free</button>
              </>
            ) : (
              <>Already have one?{" "}
                <button onClick={() => { setMode("signin"); setError(""); setMessage(""); }} className="text-white underline">Sign in</button>
              </>
            )}
          </p>
        </div>
